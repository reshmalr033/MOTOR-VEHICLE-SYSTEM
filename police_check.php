...
<div class="col-lg-6">
    <h2 style="color: #eea236;font: italic">CHECK TOLL ACTIVITY</h2>
...
$log=mysql_query("select * from add_toll where toll_name='$t1' and date='$t2'");
...
if(mysql_num_rows($log)>0)
{
   ...
   $_SESSION['time2']=$t4;
    ...
    header("location:police_result.php");
}


else
{
    header("location:police_none.php");
}

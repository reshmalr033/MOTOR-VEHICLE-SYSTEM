...
<br>
        ...
        <tr>
            <td>AMOUNT ONE WAY</td>
            <td><input type="number"name="t2"class="form-control"placeholder="Rs/-"required="required"></td>
        </tr>
        <tr>
            <td>AMOUNT TWO WAY</td>
            <td><input type="number"name="t3"class="form-control"placeholder="Rs/-"required="required"></td>
        </tr>
        <tr>
            <td></td>

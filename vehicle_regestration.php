...
{
header("location:vehicle_regestration.php?success=1");
}
else 
{
echo mysql_error();
                    ...
                    <table  class="table  table-responsive  table-striped table-bordered ">
                        ...
                        <tr>
                            <td>POLLUTION</td>
                            <td><input type="file"name="po1"required="required"></td>
                        </tr>
                        <tr>
                            <td>INSURANCE</td>
                            <td><input type="file"name="ins1"required="required"></td>
                        </tr>
                        <tr>
                            <td>RC BOOK</td>
                            <td><input type="file"name="rc1"required="required"></td>
                        </tr>
                         <tr>

...
<div class="col-lg-6">
	...
	else
	{
             if($sel=="2")
             {
                 ...
                 $t=date("h:m:a");              
                        $code=$_GET['code'];  
     mysql_query("insert into add_toll(vehicle_id,vehicle_class,amount,date,toll_id,toll_name,toll_address,time,st,uid)values('$_GET[code]','$vs2','$vt2','$date','$_SESSION[username]','$nn2','$aa2','$t','1','$dd2')");
...
echo"Incorrect Vehicle id";
     ...
     echo"Incorrect Vehicle id";
                 ...
                 $code=$_GET['code'];
     mysql_query("insert into add_toll(vehicle_id,vehicle_class,amount,date,toll_id,toll_name,toll_address,time,st,uid)values('$_GET[code]','$vs2','$vt2','$date','$_SESSION[username]','$nn2','$aa2','$t','0','$dd2')");
    
    if(mysql_affected_rows()>0)
{
header("location:Toll_regestration.php?suss=1a&mid=$code");
}
else 
{
echo"Incorrect Vehicle id1";
}
                    ...
                    <form method="post">
                            <table class="table table-bordered table-striped table-hover table-responsive">
                                <tr>
                                    ...
                                    <td><select class="form-control"name="sel" id="sel"required="">
